...
class AddMissingIndexesOnTaggings < ActiveRecord::Migration[6.0]
  ...
  def change
    ...
    add_index ActsAsTaggableOn.taggings_table,
              :taggable_id,
              algorithm: :concurrently unless index_exists? ActsAsTaggableOn.taggings_table, :taggable_id
    add_index ActsAsTaggableOn.taggings_table,
              :taggable_type,
              algorithm: :concurrently unless index_exists? ActsAsTaggableOn.taggings_table, :taggable_type
    add_index ActsAsTaggableOn.taggings_table,
              :tagger_id,
              algorithm: :concurrently unless index_exists? ActsAsTaggableOn.taggings_table, :tagger_id
    add_index ActsAsTaggableOn.taggings_table,
              :context,
              algorithm: :concurrently unless index_exists? ActsAsTaggableOn.taggings_table, :context
