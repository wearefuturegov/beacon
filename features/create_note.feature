...
Feature: Create note
  ...
  Scenario Outline: Add a note to a support action
    ...
    Examples:
      ...
      | Financial support             | Advice and Guidance  | Resident does not require help    |
      | Financial support             | Other                | Tried twice with no answer        |
      | Financial support             | Other                | Left the helpline number          |
      | Groceries and cooked meals    | Advice and Guidance  | Number not recognised             |
      ...
      | Prescription pickups          | Advice and Guidance  | Resident gets free prescriptions  |
  ...
  Scenario: Add a Advice with traveling to a Dog walking
    ...
    When I add a "Advice and Guidance" note "Resident confirmed required help"
    And I submit the form to create the note
    Then the list of notes contains "Resident confirmed required help"
    And the note category is "Advice and Guidance"
