Rails.application.configure do
  ...
  routes.default_url_options = { host: ENV['HOSTNAME'] || (ENV['HEROKU_APP_NAME'] && "#{ENV['HEROKU_APP_NAME']}.herokuapp.com") }
  ...
  # config.active_job.queue_name_prefix = "i_have_i_need_production"
