...
In the `Dockerfile.dev` on line 1 [ruby:2.5.9](https://github.com/wearefuturegov/beacon/blob/master/Dockerfile.dev#L1) we specifiy a base `Debian` image. As such the default shell is `bash`
