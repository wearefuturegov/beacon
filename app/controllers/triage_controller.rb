...
class TriageController < ApplicationController
  ...
  def edit
    AuditLog.create(request_data: audit_request_data, user_id: current_user.id, message: "User viewed triage edit page for contact ID: #{@contact.id}")
  ...
  def update
    ...
    AuditLog.create(request_data: audit_request_data, user_id: current_user.id, message: "User updated triage needs for contact ID: #{@contact.id}")
