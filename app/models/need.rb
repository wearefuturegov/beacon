...
class Need < ApplicationRecord
  ...
  delegate :name, :is_vulnerable, :address, :telephone, :delivery_details, :dietary_details, :cooking_facilities, to: :contact, prefix: true
  ...
  def self.to_csv
    attributes = %w[contact_name category name status contact_address contact_telephone contact_is_vulnerable is_urgent created_at
                    contact_delivery_details contact_dietary_details contact_cooking_facilities]
